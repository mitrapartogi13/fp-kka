...
class PacmanGraphics:
    def __init__(self, zoom=1.0, frameTime=0.0, capture=False, viewport_width=None, viewport_height=None, auto_center=False):
        self.have_window = 0
    ...
    def movePacman(self, position, direction, image):
        ...
        # Auto-center camera on Pacman if enabled
        if self.auto_center:
            center_view_on(screenPosition[0], screenPosition[1])
